...
swagpath.SwagpathView = require("./view/SwagpathView");
swagpath.SwagItemData = require("./data/SwagItemData");
},{"./data/SwagItemData":1,"./view/SwagpathView":4}],3:[function(require,module,exports){
/**
 ...
 * @method addSwagItem
 */
SwagpathView.prototype.addSwagItem = function(swagItemData) {
 ...
 * @method setup
 */
SwagpathView.prototype.setup = function() {
 ...
 * @method draw
 */
SwagpathView.prototype.draw = function() {
	background(0, 0, 0);
 ...
 */
SwagpathView.prototype.windowResized = function() {
